...
We have strong IT infrastructure and digital channels which we deploy to provide <br> exceptional service  to our customers so they can achieve their objectives.</p>
    </div>
            ...
            <div class="row text-start">
              <div class="col-12 col-sm-6 col-md-4 col-lg-8   ">
                ...
                <p class="fs-6 lh-lg px-3 mb-5">JOb FAir is an innovative Job institution that provides personal, private, corporate, commercial and digital Recruitment and  Job solutions. Our tailored emploment services delivery includes: Business Advisory, Portfolio Management, Personalised Relationship Management, Fast-tracked Service delivery and Self-service solutions Training and Re- Training of staff.
                    ...
                    At Job Fair, we believe that the New World of Fast, Smart, Personal, and Borderless Employment relationship is here. We are therefore inspired by our Future Forward jog ethos to make life (at work and leisure) more exciting for our partners with the use of cutting-edge technology that delivers best-in-class customer satisfaction.</p>

              </div >
              
              
              <div class="col-12 col-sm-6 col-md-4 col-lg-4  border-1 border rounded-5 mt-2 pt-2 shadow"><img src="assets/img/about4.jpg" alt=""height="80%"  width="100%"> <button type="button" class="btn btn-danger w-100 mt-4 ">CORPORATE PROFILE</button>
                <a href=""></a><button type="button" class="btn btn-danger w-100 mt-4 ">CERTIFICATE INCORPORATION</button>
                <a href=""></a></div> 
            </div>
          </div>
    </section>
    <section>
        <div class="container  mt-5 mb-5 border rounded-2 p-2">
            <img src="assets/img/about5.jpg" alt=""width= "100%" height= "400rem">
            <p class="text-center p-2 fs-5">Our meeting rooms are available for customer's service delivery and satisfaction</p>
        </div>
    </section>
